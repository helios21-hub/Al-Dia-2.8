...
public class AppFileProvider extends ContentProvider {
    ...
    private File resolve(Uri uri) throws FileNotFoundException {
        if(uri==null||uri.getPathSegments().size()<2||!"xlsx".equals(uri.getPathSegments().get(0)))throw new FileNotFoundException();
        ...
        if(!f.exists())throw new FileNotFoundException();return f;
    }
